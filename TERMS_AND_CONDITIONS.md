...
You retain ownership of any content you create using Blender MCP. The software itself is licensed under the MIT License — see the LICENSE file in the repository for details.
...
> **Note (personal fork):** Telemetry is disabled by default in my fork. I'm using this project purely for local experimentation and do not transmit any data.
